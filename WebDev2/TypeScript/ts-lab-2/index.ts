...
const ExerciseTwo = () => {
    ...
    const tampa: City & { coords: Coords } = {
    coords: {
        latitude: 27.9478,
        longitude: -82.4584,
    },
    ...
    function getCityInfo(city: City & { coords: Coords }) {
...
const Exercise3 = () => {
   ...
   console.log("[Exercise 3.2]", `Account value: $${bankAccount.money}`);
    ...
    pushToCollection(false, boolCollection) // Compile-time error: Argument of type 'false' is not assignable to parameter of type 'string'
    pushToCollection('hi', stringCollection)
    pushToCollection('hello', 'hi', stringCollection) // Compile-time error: Argument of type 'any[]' is not assignable to parameter of type 'string'

    pushToCollection('1', stringCollection) // Compile-time error: Argument of type 'string' is not assignable to parameter of type 'number'
